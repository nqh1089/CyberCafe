...
public class AD_TAB2_Order extends javax.swing.JFrame {
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        ...
        try (Connection con = DBConnection.getConnection()) {
            ...
            // Kiểm tra từng sản phẩm để xác định có Gói nạp không
            ...
            // Nếu có Gói nạp thì hỏi tên tài khoản và kiểm tra
            if (coGoiNap) {
            ...
            // Mở form QR, truyền thêm thông tin Gói nạp nếu có
            if (coGoiNap) {
                new TAB2_QR(maHD, nguoiTao, tongTienSP, giamGia, thanhToan, tableOrder, this, tenTaiKhoanNap, soTienNap).setVisible(true);
            } else {
