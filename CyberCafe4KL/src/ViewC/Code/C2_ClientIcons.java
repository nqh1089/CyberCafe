...
public class C2_ClientIcons {
    ...
    public static void LoadIcons(JPanel pnlCN) {
        ...
        String[] names = { "chat", "order", "dangxuat", "matkhau", "khoamay" };
        ...
        row2Wrapper.setMaximumSize(new Dimension(300, 40));
        row2Wrapper.setBorder(BorderFactory.createEmptyBorder(2, 0, 0, 0));
        row2Wrapper.add(row2, BorderLayout.CENTER);

        for (int i = 0; i < iconFiles.length; i++) {
            JPanel itemPanel = new JPanel();
            itemPanel.setPreferredSize(new Dimension(60, 69));
